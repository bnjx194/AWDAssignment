...
<main class="property-page-wrap">
    <section class="property-page-head">
        ...
        <div class="property-page-actions">
            <a href="{{ route('buy') }}" class="property-page-btn property-page-btn-primary">View Active Listings</a>
            <a href="/" class="property-page-btn property-page-btn-secondary">Back to Welcome</a>
        </div>
    </section>

    <section class="property-grid">
        @forelse ($properties as $property)
            <a href="{{ route('property.show', $property->id) }}" class="property-card">
                ...
                <div class="property-card-content">
                    <h3>{{ Str::limit($property->description, 52) }}</h3>
                    <p>{{ $property->address->address ?? 'Address unavailable' }}</p>
